...
RcppExport SEXP _rangercase_numSmaller(SEXP valuesSEXP, SEXP referenceSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_rangercase_rangerCpp", (DL_FUNC) &_rangercase_rangerCpp, 44},
    {"_rangercase_numSmaller", (DL_FUNC) &_rangercase_numSmaller, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_rangercase(DllInfo *dll) {
